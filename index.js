...
const tokenjson = require("./ropstentokens.json");

let currentTrade = {};
let currentSelectSide;
let tokens;
let currentNetwork = "Ropsten";

async function init() {
  document.getElementById("selected_network").innerHTML = currentNetwork;
...
async function connect() {
  if (typeof window.ethereum !== "undefined") {
    ...
    document.getElementById(
      "login_button"
    ).innerHTML = `Connected: ${addr.substring(0, 5)}...${addr.substring(
      addr.length - 4
    )}`;
...
//   console.log("Getting Quote", account);
...
//   console.log("Quote from", swapQuoteJSON.from);
//   console.log("estimatedgas:", swapQuoteJSON.estimatedGas);
...
async function trySwap() {
  ...
  //   ERC20TokenContract.allowance(takerAddress, swapQuoteJSON.allowanceTarget)
  // );
  ...
  console.group("takeradderss", takerAddress);
